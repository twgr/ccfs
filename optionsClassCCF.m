classdef optionsClassCCF
    ...
    properties
        ...
        % 'rotationForest'.  'rotationForest' currently only supported
        treeRotation = 'none';
        ...
        % mention it.  This is a little bizarre as the parameter seems
        % paramount to the performance of rotation forest and the
        % performance cannot be matched if set to 0.
