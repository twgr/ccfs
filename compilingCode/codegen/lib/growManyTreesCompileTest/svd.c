  ...
  emxArray_real_T *S, emxArray_real_T *V)
{
  ...
  i18 = s->size[0];
  s->size[0] = ns;
  emxEnsureCapacity((emxArray__common *)s, i18, (int)sizeof(double));
  for (i18 = 0; i18 < ns; i18++) {
    s->data[i18] = 0.0;
  }
  ...
  i18 = e->size[0];
  e->size[0] = ns;
  emxEnsureCapacity((emxArray__common *)e, i18, (int)sizeof(double));
  for (i18 = 0; i18 < ns; i18++) {
    e->data[i18] = 0.0;
  }
  ...
  U->size[0] = ns;
  emxEnsureCapacity((emxArray__common *)U, i18, (int)sizeof(double));
  i18 = U->size[0] * U->size[1];
  U->size[1] = minnp;
  emxEnsureCapacity((emxArray__common *)U, i18, (int)sizeof(double));
  ns *= minnp;
  ...
  ns = A->size[1];
  qs = A->size[1];
  i18 = V->size[0] * V->size[1];
  V->size[0] = ns;
  emxEnsureCapacity((emxArray__common *)V, i18, (int)sizeof(double));
  i18 = V->size[0] * V->size[1];
  V->size[1] = qs;
  emxEnsureCapacity((emxArray__common *)V, i18, (int)sizeof(double));
  ns *= qs;
  ...
  if ((A->size[0] == 0) || (A->size[1] == 0)) {
    ...
    for (q = 0; q + 1 <= m; q++) {
      if (s->data[q] != 0.0) {
        ...
        if (q + 1 <= A->size[0]) {
          i18 = A->size[0] * q + 1;
          eml_xscal(A->size[0], ztest0, U, i18);
        }
      }
      ...
      if ((q + 1 < m) && (e->data[q] != 0.0)) {
        ...
        s->data[q + 1] *= ztest0;
        i18 = A->size[1] * (q + 1) + 1;
        eml_xscal(A->size[1], ztest0, V, i18);
      }
    }
      ...
      switch (ns) {
       case 1:
        ...
        for (ns = m - 2; ns + 1 >= q + 1; ns--) {
          ...
          i18 = A->size[1] * ns + 1;
          qs = A->size[1] * (m - 1) + 1;
          eml_xrot(A->size[1], V, i18, qs, ztest, b);
        }
        break;
       ...
       case 2:
        ...
        for (ns = q; ns + 1 <= m; ns++) {
          ...
          i18 = A->size[0] * ns + 1;
          qs = A->size[0] * (q - 1) + 1;
          eml_xrot(A->size[0], U, i18, qs, ztest, b);
        }
        break;
       ...
       default:
        ...
        while ((q + 1 < nct) && (s->data[q] < s->data[ns])) {
          ...
          if (q + 1 < A->size[1]) {
            i18 = A->size[1] * q + 1;
            qs = A->size[1] * (q + 1) + 1;
            eml_xswap(A->size[1], V, i18, qs);
          }

          if (q + 1 < A->size[0]) {
            i18 = A->size[0] * q + 1;
            qs = A->size[0] * (q + 1) + 1;
            eml_xswap(A->size[0], U, i18, qs);
          }
         ...
         emxArray_real_T *V)
{
  ...
  if (A->size[0] >= A->size[1]) {
    ...
    for (i17 = 0; i17 < 2; i17++) {
      uv3[i17] = (unsigned int)A->size[i17];
    }
