...
emxArray_int64_T *emxCreateND_int64_T(int numDimensions, int *size)
{
  ...
  emx->data = (long *)calloc((unsigned int)numEl, sizeof(long));
  emx->numDimensions = numDimensions;
  emx->allocatedSize = numEl;
  return emx;
}
 ...
 * Return Type  : emxArray_int64_T *
 */
emxArray_int64_T *emxCreateWrapperND_int64_T(long *data, int numDimensions, int *
  size)
{
  emxArray_int64_T *emx;
  int numEl;
 ...
 * Return Type  : emxArray_int64_T *
 */
emxArray_int64_T *emxCreateWrapper_int64_T(long *data, int rows, int cols)
{
  emxArray_int64_T *emx;
  int size[2];
  int numEl;
