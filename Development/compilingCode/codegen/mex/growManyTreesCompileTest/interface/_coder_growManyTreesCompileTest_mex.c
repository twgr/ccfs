...
static void growManyTreesCompileTest_mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  c_growManyTreesCompileTestStack* d_growManyTreesCompileTestStack = (c_growManyTreesCompileTestStack*)mxCalloc(1,sizeof(c_growManyTreesCompileTestStack));
  ...
  /* Call the function. */
  growManyTreesCompileTest_api(d_growManyTreesCompileTestStack, inputs, outputs);
  ...
  mxFree(d_growManyTreesCompileTestStack);
}
